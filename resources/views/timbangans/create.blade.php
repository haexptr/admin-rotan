<x-app-layout>
    ...
    <div class="min-h-screen p-6 bg-gray-50 dark:bg-gray-900">
        <div class="max-w-2xl mx-auto">
            ...
            <div class="flex items-center justify-between mb-8">
                <div>
                    <h1 class="text-2xl font-light text-gray-900 dark:text-gray-100 tracking-tight">Tambah Timbangan</h1>
                ...
                <div class="p-8">
                    <form action="{{ route('timbangans.store') }}" method="POST" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <input type="text" name="nama_penjual" id="nama_penjual" value="{{ old('nama_penjual') }}" placeholder="Masukkan nama penjual" class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border-0 rounded-xl text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 focus:bg-white dark:focus:bg-gray-600 focus:ring-2 focus:ring-slate-500 dark:focus:ring-slate-400 focus:ring-offset-0 transition-all duration-200" required>
                        ...
                        <div class="space-y-2">
                            ...
                            <textarea name="deskripsi_timbangan" id="deskripsi_timbangan" rows="4" placeholder="Tambahkan keterangan (opsional)" class="w-full px-4 py-3 bg-gray-50 dark:bg-gray-700 border-0 rounded-xl text-gray-900 dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 resize-none focus:bg-white dark:focus:bg-gray-600 focus:ring-2 focus:ring-slate-500 dark:focus:ring-slate-400 focus:ring-offset-0 transition-all duration-200">{{ old('deskripsi_timbangan') }}</textarea>
    ...
    <script>
        function employeeSelector() {
            return {
                searchQuery: '',
                selectedEmployees: @json(old('id_karyawan', [])),
