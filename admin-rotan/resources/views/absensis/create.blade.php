<x-app-layout>
    ...
    <div class="space-y-4">
        <div class="flex justify-between items-center">
            <h2 class="text-xl font-semibold text-gray-900">Tambah Absensi</h2>
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        <label class="flex items-center">
                            <input type="radio" name="status" value="hadir" class="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500" {{ old('status') == 'hadir' ? 'checked' : '' }} required>
                            <span class="ml-2 text-sm text-gray-700">Hadir</span>
                        </label>
                        <label class="flex items-center">
                            <input type="radio" name="status" value="tidak_hadir" class="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500" {{ old('status') == 'tidak_hadir' ? 'checked' : '' }} required>
                            <span class="ml-2 text-sm text-gray-700">Tidak Hadir</span>
                        </label>
                        <label class="flex items-center">
                            <input type="radio" name="status" value="izin" class="h-4 w-4 text-blue-600 border-gray-300 focus:ring-blue-500" {{ old('status') == 'izin' ? 'checked' : '' }} required>
